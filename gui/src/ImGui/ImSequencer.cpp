...
namespace ImSequencer
{
    ...
    static bool SequencerAddDelButton(ImDrawList* draw_list, ImVec2 pos, bool add = true)
    {
        ...
        int delColor = overDel ? ImGui::GetColorU32(ImGuiCol_Text) : ImGui::GetColorU32(ImGuiCol_Text,0.75f);
    ...
    bool Sequencer(SequenceInterface *sequence, int *currentFrame, bool *expanded, int *selectedEntry, int *firstFrame, int sequenceOptions)
    {
        ...
        if (expanded && !*expanded)
        {
            ...
            draw_list->AddRectFilled(canvas_pos, ImVec2(canvas_size.x + canvas_pos.x, canvas_pos.y + ItemHeight), ImGui::GetColorU32(ImGuiCol_Header), 0);
            char tmps[512];
            sprintf(tmps, "%d Frames / %d entries", frameCount, sequenceCount);
            draw_list->AddText(ImVec2(canvas_pos.x + 26, canvas_pos.y + 2),ImGui::GetColorU32(ImGuiCol_Text), tmps);
        }
        else
        {
            ...
            */
            ...
            draw_list->AddRectFilled(canvas_pos, canvas_pos + headerSize, (ImColor)carnot::Color::Red, 0);
            ...
            // full background
            draw_list->AddRectFilled(canvas_pos, canvas_pos + canvas_size, ImGui::GetColorU32(ImGuiCol_FrameBg), 0);
            ...
            //header
            draw_list->AddRectFilled(canvas_pos, ImVec2(canvas_size.x + canvas_pos.x, canvas_pos.y + ItemHeight), ImGui::GetColorU32(ImGuiCol_ScrollbarBg), 0);
            ...
            auto drawLine = [&](int i, int regionHeight) {
                ...
                {
                    draw_list->AddLine(ImVec2((float)px, canvas_pos.y + (float)tiretStart), ImVec2((float)px, canvas_pos.y + (float)tiretEnd - 1), ImGui::GetColorU32(ImGuiCol_Text), 1);

                    draw_list->AddLine(ImVec2((float)px, canvas_pos.y + (float)ItemHeight), ImVec2((float)px, canvas_pos.y + (float)regionHeight - 1), ImGui::GetColorU32(ImGuiCol_Text), 1);
                }
                ...
                if (baseIndex && px > (canvas_pos.x + legendWidth))
                {
                    char tmps[512];
                    sprintf(tmps, "%d", i);
                    draw_list->AddText(ImVec2((float)px + 3.f, canvas_pos.y), ImGui::GetColorU32(ImGuiCol_Text), tmps);
                }
            ...
            auto drawLineContent = [&](int i, int regionHeight) {
                ...
                if (px <= (canvas_size.x + canvas_pos.x) && px >= (canvas_pos.x + legendWidth))
                {
                    ...
                    draw_list->AddLine(ImVec2(float(px), float(tiretStart)), ImVec2(float(px), float(tiretEnd)), ImGui::GetColorU32(ImGuiCol_TextDisabled), 1);
                }
            };
            ...
            for (int i = 0; i < sequenceCount; i++)
            {
                ...
                draw_list->AddText(tpos, ImGui::GetColorU32(ImGuiCol_Text), sequence->GetItemLabel(i));
            ...
            for (int i = 0; i < sequenceCount; i++)
            {
                unsigned int col = (i & 1) ? ImGui::GetColorU32(ImGuiCol_ScrollbarBg) : ImGui::GetColorU32(ImGuiCol_ScrollbarBg, 0.5);
                ...
                {
                    col = ImGuiCol_ScrollbarGrabHovered;
                    pos.x -= legendWidth;
                }
            ...
            if (hasScrollBar)
            {
                ...
                draw_list->AddRectFilled(scrollBarA, scrollBarB, ImGui::GetColorU32(ImGuiCol_ChildBg), 0);

                ImRect scrollBarRect(scrollBarA, scrollBarB);
                bool inScrollBar = scrollBarRect.Contains(io.MousePos);

                // background
                draw_list->AddRectFilled(scrollBarA, scrollBarB, ImGui::GetColorU32(ImGuiCol_ScrollbarBg), 8);
                ...
                draw_list->AddRectFilled(scrollBarC, scrollBarD, (inScrollBar || MovingScrollBar) ? ImGui::GetColorU32(ImGuiCol_ScrollbarGrab) : ImGui::GetColorU32(ImGuiCol_ScrollbarGrab), 6);
                ...
                draw_list->AddRectFilled(barHandleLeft.Min, barHandleLeft.Max, (onLeft || sizingLBar)     ? ImGui::GetColorU32(ImGuiCol_ScrollbarGrabHovered) : ImGui::GetColorU32(ImGuiCol_ScrollbarGrab), 6);
                draw_list->AddRectFilled(barHandleRight.Min, barHandleRight.Max, (onRight || sizingRBar ) ? ImGui::GetColorU32(ImGuiCol_ScrollbarGrabHovered) : ImGui::GetColorU32(ImGuiCol_ScrollbarGrab), 6);
