...
- On macOS, the executable `syntacts-gui` may not run, and it will instead open the binary code. If this occurs, run the following command in a Terminal. After this, you will be able to successfully run `syntacts-gui`.
